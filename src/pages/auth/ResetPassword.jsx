    ...
    <div className="auth-wrapper">
      <div className="auth-left">
        ...
        <div className="auth-tagline">
          <h2>{isFirstLogin ? 'Welcome to Schoolers' : 'Keep Your Account Secure'}</h2>
          <p>{isFirstLogin
      ...
      <div className="auth-right">
        <div className="auth-right-inner">
          ...
          <div className="auth-form-header" style={{ textAlign: 'center' }}>
            ...
            <p>{isFirstLogin
              ? 'Enter your temporary password and set a new one to continue.'
              : 'Enter your current and new password to update'}</p>
          </div>

          {isFirstLogin && (
            <div className="alert-success" style={{ marginBottom: '16px' }}>
              <span className="material-icons" style={{ fontSize: '16px' }}>info</span>
              First login detected. Enter the temporary password you received, then set a new one.
            </div>
          )}
          ...
          <form onSubmit={handleSubmit}>
            {[
              { name: 'previousPassword', label: isFirstLogin ? 'Temporary Password' : 'Previous Password', showKey: 'prev', placeholder: isFirstLogin ? 'Enter temporary password' : 'Enter current password' },
