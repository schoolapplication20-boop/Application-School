    ...
    <Layout pageTitle="Messages">
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
        <div>
          ...
          <p style={{ margin: 0, color: 'var(--text-secondary)', fontSize: 14 }}>Send announcements to classes or the entire school</p>
        </div>
        <button
        ...
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.4)', zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
          <div style={{ background: 'var(--surface)', borderRadius: 16, width: '100%', maxWidth: 560, padding: 32, boxShadow: '0 8px 32px rgba(0,0,0,0.18)' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
              ...
              <button onClick={() => { setShowForm(false); setForm(empty()); }} style={{ background: 'none', border: 'none', cursor: 'pointer', fontSize: 20, color: 'var(--text-secondary)' }}>✕</button>
            </div>
              ...
              <div>
                ...
                <div style={{ display: 'flex', gap: 8, marginBottom: 8 }}>
                  <button
                    ...
                    style={{ flex: 1, padding: '8px', border: `2px solid ${form.isSchoolWide ? '#4f46e5' : 'var(--border-strong)'}`, borderRadius: 8, background: form.isSchoolWide ? '#eef2ff' : 'var(--surface)', color: form.isSchoolWide ? '#4f46e5' : 'var(--text-secondary)', fontWeight: 600, cursor: 'pointer', fontSize: 13 }}
                  >
                    🏫 Entire School
                  </button>
                  <button
