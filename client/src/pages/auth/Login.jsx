        ...
        <div className="auth-right-inner">
          ...
          <div className="auth-form-header">
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '20px' }}>
              ...
              <span style={{ fontSize: '20px', fontWeight: 800, color: 'var(--text-primary)', fontFamily: 'Poppins, sans-serif', letterSpacing: '-.3px' }}>
                {school?.name || 'My-Skoolz'}
              </span>
            </div>
            <h1 style={{ fontSize: '26px', fontWeight: 900, marginBottom: '6px', color: 'var(--text-primary)', letterSpacing: '-.5px' }}>
            ...
            <p style={{ fontSize: '13.5px', color: 'var(--text-secondary)', lineHeight: 1.6 }}>Select your role below to access your portal</p>
          </div>

          {/* Role Selector — hidden during owner OTP step */}
          {!ownerOtpStep && <div style={{ marginBottom: '22px' }}>
            <label style={{ fontSize: '11px', fontWeight: 700, color: 'var(--text-muted)', display: 'block', marginBottom: '10px', textTransform: 'uppercase', letterSpacing: '.06em' }}>
              Select Your Role
            </label>
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      borderRadius: '14px',
                      border: isSelected ? `2px solid ${role.color}` : '2px solid var(--border-strong)',
                      background: isSelected ? role.bg : 'var(--surface-alt)',
                      cursor: 'pointer',
                  ...
                  >
                    <div style={{
                      ...
                      background: isSelected ? role.color : 'var(--border-strong)',
          ...
          {ownerOtpStep && (
            <form onSubmit={handleOwnerOtpSubmit}>
              ...
              <button type="button" onClick={() => { setOwnerOtpStep(false); setOwnerOtp(''); setOwnerEmail(''); setError(''); }}
                style={{ width: '100%', marginTop: 10, background: 'none', border: '1px solid var(--border-strong)', borderRadius: 8, padding: '9px 0', fontSize: 13, color: 'var(--text-secondary)', cursor: 'pointer' }}>
                ← Back to login
              </button>
            </form>
          )}
