...
const styles = StyleSheet.create({
  ...
  sendBtn: { backgroundColor: '#7c3aed', margin: 12, borderRadius: 12, padding: 14, alignItems: 'center' },
  ...
  classSec: { fontSize: 12, color: '#7c3aed', fontWeight: '600' },
  ...
  saveBtn: { flex: 1, backgroundColor: '#7c3aed', borderRadius: 10, padding: 13, alignItems: 'center' },
