          ...
          <View style={styles.modal}>
            ...
            <ScrollView keyboardShouldPersistTaps="handled">
              ...
              <ScrollView horizontal showsHorizontalScrollIndicator={false} style={{ marginBottom: 12 }}>
                {LEAVE_TYPES.map(t => (
                  <TouchableOpacity key={t} style={[styles.typeChip, form.leaveType === t && styles.typeChipActive]} onPress={() => setForm(f => ({ ...f, leaveType: t }))}>
...
const styles = StyleSheet.create({
  ...
  applyBtn: { backgroundColor: '#f97316', margin: 12, borderRadius: 12, padding: 14, alignItems: 'center' },
