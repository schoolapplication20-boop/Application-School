...
const mockExpenses = [
  { id: 1, category: 'Salaries', description: 'March teacher salaries', amount: 420000, date: '01 Mar 2026', addedBy: 'Admin' },
  { id: 2, category: 'Infrastructure', description: 'Classroom renovation - Block B', amount: 85000, date: '05 Mar 2026', addedBy: 'Admin' },
  { id: 3, category: 'Utilities', description: 'Electricity bill - March', amount: 12500, date: '07 Mar 2026', addedBy: 'Admin' },
  { id: 4, category: 'Supplies', description: 'Stationery and art supplies', amount: 8200, date: '10 Mar 2026', addedBy: 'Admin' },
  { id: 5, category: 'Technology', description: 'Software license renewal', amount: 35000, date: '12 Mar 2026', addedBy: 'Admin' },
  { id: 6, category: 'Transport', description: 'School bus maintenance', amount: 18000, date: '15 Mar 2026', addedBy: 'Admin' },
  { id: 7, category: 'Sports', description: 'Sports equipment purchase', amount: 22000, date: '16 Mar 2026', addedBy: 'Admin' },
  { id: 8, category: 'Utilities', description: 'Water and internet bill', amount: 6800, date: '17 Mar 2026', addedBy: 'Admin' },
];
...
const Expenses = () => {
  ...
  const handleAdd = () => {
    ...
    setExpenses([{ id: Date.now(), ...formData, amount: parseFloat(formData.amount), addedBy: 'Admin' }, ...expenses]);
    setShowModal(false);
  };
  ...
  return (
    <div className="app-layout">
      ...
      <div className={`main-content ${sidebarCollapsed ? 'sidebar-collapsed' : ''}`}>
        <Navbar pageTitle="Expenses" onMenuToggle={() => {
